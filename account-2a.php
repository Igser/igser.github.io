					...
					<div class="account-content">
						...
						<div class="account-data content-border">
							...
							<div class="block clearfix">
								...
								<div class="input-box">
									<div class="aligner"><input type="text" class="data" value="Петр" disabled></div>
									<div class="aligner">
										<a href="#" class="btn-edit"></a>
										<a href="#" class="btn-check"></a>
									</div>
							...
							<div class="block clearfix">
								...
								<div class="input-box">
									<div class="aligner"><input type="text" class="data" value="Иванов" disabled></div>
									<div class="aligner">
										<a href="#" class="btn-edit"></a>
										<a href="#" class="btn-check"></a>
									</div>
							...
							<div class="block clearfix">
								<div class="label-text">Дата рождения</div>
								<div class="input-box">
									<div class="aligner"><input type="text" class="data" value="12.12.1970" disabled></div>
									<div class="aligner">
										<a href="#" class="btn-edit"></a>
										<a href="#" class="btn-check"></a>
									</div>
